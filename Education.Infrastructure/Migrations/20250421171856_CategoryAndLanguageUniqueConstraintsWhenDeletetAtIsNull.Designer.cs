...
namespace Education.Infrastructure.Migrations
{
    ...
    [Migration("20250421171856_CategoryAndLanguageUniqueConstraintsWhenDeletetAtIsNull")]
    partial class CategoryAndLanguageUniqueConstraintsWhenDeletetAtIsNull
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuestionQuiz", b =>
                {
                    b.HasOne("Education.Persistence.Questions.Question", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_question_quiz_questions_questions_question_id");
                    ...
                    b.HasOne("Education.Persistence.Quizes.Quiz", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_question_quiz_quizzes_quizzes_quiz_id");
                });
